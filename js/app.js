...
let sliderInSlider = new Swiper('.slider-in-slider', {
	...
	pagination: {
		el: '.slider-in-slider__pagination',
		type: 'bullets',
		clickable: true,
		bulletClass: 'slider-in-slider__bullet',
		bulletActiveClass: 'slider-in-slider_active',
	},
...
function menuSliderRemove() {
	let menuLinkActive = document.querySelector('.header__menu-link._active');
	if (menuLinkActive) {
...
function setScrollType() {
	...
	for (let index = 0; index < pageSlider.slides.length; index++) {
		...
		if (pageSlideContent) {
			...
			if ((pageSlideContentHeight + headerHeight) > window.innerHeight) {
				console.log(11);
